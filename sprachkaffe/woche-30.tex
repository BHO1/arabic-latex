...
\fbox{%
  \parbox{0.9\textwidth}{%
  \textbf{\textenglish{each/every}} (\textenglish{indefinit noun} + كل) 
  \par
  \textbf{\textenglish{all}}(\textenglish{indefinit noun} + كل ) }%
}
...
\fbox{%
  \parbox{0.7\textwidth}{%
  \textbf{ما} + (\textenglish{past}/ ألماضي ) 
  \par
    \textbf{لم} + (\textenglish{past} ألمُدارِع ألمجزوم) 
  }%
}
...
\fbox{%
  \parbox{0.7\textwidth}{%
  \textbf{لِ} + (\textenglish{subjunctive}/  ألمُدارِع ألمنصوب) 
  \par
    \textbf{لِ} + (\textenglish{verbal noun} ألمصدر ) 
  }%
}
...
% تمرين كلمات جديدة (في الصف)
% خالد أَكبَر ولد في أسرته
% بالنسبة لي " سان فرانسيسكو" أَجْمَلَ مَدِينَة فِي أَمْرِيكَا
% " هارفارد" أَقِدَم جَامِعَة أَمْرِيكِية
% الأَحَد هُؤَ أَوَّل يَوم فِي الأُسْبُوع
% أَبْرَد طقس فِي أَمْرِيكَا فِي آلاَسْكا
